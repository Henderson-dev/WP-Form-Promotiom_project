<?php
// Defina aqui os links do regulamento da promoção
$link_regulamento = TEMPLATE . "/asset/pdf/regulamento.pdf";
$link_politica = TEMPLATE . "/assets/pdf/politica_privacidade.pdf";
        ...
        <main id="form-promo-page" style="background-color: transparent ">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 d-flex flex-column align-items-center mx-auto">
                    ...
                    <form name="form_promocao" id="form_promocao" class="containerPromo" method="post"
                        action="<?php echo SITE; ?>/home/cadastro-da-promocao/" enctype="multipart/form-data">
                        <div class="row">
                            <?php if ($uri == 'lnds'): ?>
                                <div class="col-12 alert alert-danger text-center mb-5">
                                    <p style="margin-bottom: 0;"><span style="font-weight: bold;">ATENÇÃO</span><br>Você
                                        atingiu o limite de números da sorte gerados para esta promoção. <br>Obrigado por
                                        participar!</p>
                                </div>
                            <?php elseif ($uri == 'rec'): ?>
                                <div class="col-12 alert alert-danger text-center mb-5">
                                    <p style="margin-bottom: 0;"><span style="font-weight: bold;">ATENÇÃO</span><br>Você
                                        precisa esperar o tempo limite para realizar um novo cadastro, tente outra vez mais
                                        tarde!</p>
                                </div>
                            <?php elseif (isset($_GET['qt'])): ?>
                                <div class="col-12 alert alert-danger text-center mb-5">
                                    <p style="margin-bottom: 0;"><span style="font-weight: bold;">ATENÇÃO</span><br>Você só
                                        pode cadastrar <?php echo $_GET['qt']; ?> produto(s) para esta promoção.<br>Por
                                        favor faça seu cadastro novamente com a quantidade de produtos informada acima.</p>
                                </div>
                            <?php endif; ?>

                            <div class="col-12">
                                <h1>1º PASSO</h1>
                                <p>Cadastre seus dados no formulário abaixo:</p>
                                <label>Seu nome completo*</label>
                                <input type="text" name="nome" id="nome" value="" maxlength="160" size="240"
                                    aria-required="true" placeholder="Ex: Sandra Martiz de Oliveira" required />
                            </div>

                            <div class="col-12">
                                <label>Seu email*</label>
                                <input type="email" name="email" id="email" value="" maxlength="100" size="100"
                                    aria-required="true" placeholder="Ex: sandraoliveira@email.com" required />
                            </div>

                            <div class="col-md-6">
                                <label>Seu celular com DDD*</label>
                                <input type="text" name="telefone" id="telefone" maxlength="18" value="" size="18"
                                    aria-required="true" placeholder="Ex: (11) 93333-3333" required />
                            </div>

                            <div class="col-md-6">
                                <label>Seu CPF*</label>
                                <input type="text" name="cpf" id="cpf" maxlength="14" value="" size="14"
                                    aria-required="true" placeholder="Ex: 000.000.000-00" required />
                            </div>

                            <div class="col-md-6">
                                <label>Data de nascimento*</label>
                                <input type="text" name="nascimento" id="nascimento" value="" maxlength="10" size="10"
                                    aria-required="true" placeholder="Ex: 11/05/1975" required />
                            </div>

                            <div class="col-md-6">
                                <label>Sua cidade *</label>
                                <div class="box-select selectCustom">
                                    <select name="cidade" id="cidade">
                                        ...
                                        <option value="Alfredo Marcondes">
                                            Alfredo Marcondes
                                        </option>
                                        ...
                                        <option value="Américo de Campos">
                                            Américo de Campos
                                        </option>
                                        ...
                                        <option value="Barão de Antonina">
                                            Barão de Antonina
                                        </option>
                                        ...
                                        <option value="Bragança Paulista">
                                            Bragança Paulista
                                        </option>
                                        ...
                                        <option value="Cabrália Paulista">
                                            Cabrália Paulista
                                        </option>
                                        <option value="Cabreúva">Cabreúva</option>
                                        <option value="Caçapava">Caçapava</option>
                                        <option value="Cachoeira Paulista">
                                            Cachoeira Paulista
                                        </option>
                                        ...
                                        <option value="Cândido Rodrigues">
                                            Cândido Rodrigues
                                        </option>
                                        ...
                                        <option value="Cristais Paulista">
                                            Cristais Paulista
                                        </option>
                                        ...
                                        <option value="Engenheiro Coelho">
                                            Engenheiro Coelho
                                        </option>
                                        ...
                                        <option value="Nova Guataporanga">
                                            Nova Guataporanga
                                        </option>
                                        <option value="Nova Independência">
                                            Nova Independência
                                        </option>
                                        ...
                                        <option value="Palmares Paulista">
                                            Palmares Paulista
                                        </option>
                                        <option value="Palmeira d'Oeste">
                                            Palmeira d'Oeste
                                        </option>
                                        <option value="Palmital">Palmital</option>
                                        <option value="Panorama">Panorama</option>
                                        <option value="Paraguaçu Paulista">
                                            Paraguaçu Paulista
                                        </option>
                                        ...
                                        <option value="Pedrinhas Paulista">
                                            Pedrinhas Paulista
                                        </option>
                                        ...
                                        <option value="Redenção da Serra">
                                            Redenção da Serra
                                        </option>
                                        ...
                                        <option value="Ribeirão Corrente">
                                            Ribeirão Corrente
                                        </option>
                                        ...
                                        <option value="Salto de Pirapora">
                                            Salto de Pirapora
                                        </option>
                                        ...
                                        <option value="Santa Rita d'Oeste">
                                            Santa Rita d'Oeste
                                        </option>
                                        ...
                                        <option value="São Luiz do Paraitinga">
                                            São Luiz do Paraitinga
                                        </option>
                                        <option value="São Manuel">São Manuel</option>
                                        <option value="São Miguel Arcanjo">
                                            São Miguel Arcanjo
                                        </option>
                                        <option value="São Paulo">São Paulo</option>
                                        <option value="São Pedro">São Pedro</option>
                                        <option value="São Pedro do Turvo">
                                            São Pedro do Turvo
                                        </option>
                            ...
                            <div class="col-md-12 checkcustom">
                                <div class="wrap-check">
                                    <div class="check-form">
                                        <label>
                                            <input type="checkbox" name="regulamento" id="regulamento"
                                                value="Regulamento" required />
                                            <p class="wpcf7-list-item-label">
                                                Aceito os termos do
                                                <a href="<?php echo $link_regulamento; ?>"
                            ...
                            <div class="col-md-12 checkcustom m-0">
                                <div class="wrap-check">
                                    <div class="check-form">
                                        <label>
                                            <input type="checkbox" name="regulamento" id="privacidade"
                                                value="privacidade" required />
                                            <p class="wpcf7-list-item-label">
                                                Aceito a
                                                <a href="<?php echo $link_politica; ?>"   target="_blank">Política de
                                                    Privacidade</a>
                                            </p>
                                        </label>
                                    </div>
                            ...
                            <div class="col-12 divider">
                                <h1>2º PASSO</h1>
                                <p>
                                    Anexe seu cupom fiscal no campo abaixo.<br />Selecione
                                    apenas um arquivo no formato JPG, PNG ou PDF. Tamanho
                                    máximo do arquivo 4MB.
                                </p>
                                <div class="uploadAnexo">
                                    <input type="hidden" name="MAX_FILE_SIZE" value="5194304" />
                                    <input type="file" name="my_file_upload" id="my_file_upload"
                                        accept="application/pdf,image/*" id="bto-anexar" required />
                                    <!-- Não retirar o ID desse botão -->
                                    <label for="bto-anexar">ANEXAR</label>
                                </div>
                            </div>
                            <div class="col-12 mt-5">
                                <label>Nome do estabelecimento*</label>
                                <input type="text" name="estabelecimento" id="estabelecimento" value="" maxlength="100"
                                    size="100" aria-required="true" placeholder="Ex: loja #####" required />
                            </div>
                            <div class="col-md-12 checkcustom">
                                <div class="wrap-check">
                                    <div class="check-form">
                                        <label>
                                            <input type="checkbox" name="regulamento" id="regulamento2"
                                                value="Regulamento2" />
                                            <p class="wpcf7-list-item-label">
                                                *Estou ciente de que preciso guardar os cupons
                                                fiscais cadastrados
                                                <a href="<?php echo $link_regulamento; ?>"
                                                    target="_blank">regulamento</a>
                                            </p>
                            ...
                            <div class="col-12 divider-produtos">
                                <h1>3º PASSO</h1>
                                <p>
                                    Digite o código de barras, referentes aos produto que você
                                    comprou e a quantidade do mesmo produto. Fique atento(a) à
                                    questão da quantidade pois o preenchimento incorreto
                                    levará à desclassificação dos códigos cadastrados.
                                </p>

                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_01.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Arroz Integral</label>
                                        <input type="text" name="arroz_integral" id="arroz_integral" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_arroz_integral" id="qt_arroz_integral" value="0"
                                            aria-required="true" placeholder="0" min="0"
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_03.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Arroz para Risoto</label>
                                        <input type="text" name="arroz_para_risoto" id="arroz_para_risoto" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_arroz_para_risoto" id="qt_arroz_para_risoto"
                                            value="0" aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_05.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Arroz Parbolizado</label>
                                        <input type="text" name="arroz_parbolizado" id="arroz_parbolizado" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_arroz_parbolizado" id="qt_arroz_parbolizado"
                                            value="0" aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_06.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Arroz Branco Tipo 1</label>
                                        <input type="text" name="arroz_branco_tipo_1" id="arroz_branco_tipo_1" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_arroz_branco_tipo_1" id="qt_arroz_branco_tipo_1"
                                            value="0" aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_07.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Feijão Preto</label>
                                        <input type="text" name="feijao_preto" id="feijao_preto" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_feijao_preto" id="qt_feijao_preto" value="0"
                                            aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_08.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Feijão Bolinha</label>
                                        <input type="text" name="feijao_bolinha" id="feijao_bolinha" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_feijao_bolinha" id="qt_feijao_bolinha" value="0"
                                            aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                                ...
                                <div class="row passo3-produtos">
                                    <div class="col-4 offset-4 offset-md-0 col-md-3">
                                        <img src="<?php echo TEMPLATE; ?>/assets/images/produto_09.webp"
                                            width="97" height="121" alt="" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label>Feijão Carioca</label>
                                        <input type="text" name="feijao_carioca" id="feijao_carioca" value=""
                                            aria-required="true" maxlength="300"
                                            placeholder="Digite o código de barras" />
                                    </div>
                                    <div class="col-12 col-md-3">
                                        <label>Quantidade</label>
                                        <input type="number" name="qt_feijao_carioca" id="qt_feijao_carioca" value="0"
                                            aria-required="true" placeholder="0" min="0"
                                            oninput="validity.valid||(value='');" />
                                    </div>
                                </div>
                            ...
                            <div class="flex mx-auto text-center">
                                <input type="submit" value="Enviar" id="bto-enviar" />
                                <!-- Não tirar o ID deste botão -->
...
<!-- Overlay de mensagem sendo enviada -->
<div id="mensagem">
    <img src="<?php echo TEMPLATE; ?>/assets/images/loader.gif" alt="">
</div>